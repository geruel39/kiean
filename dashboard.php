...
<body>
    ...
    <div class="w-full py-16 px-10">
        ...
        <div class="h-60 flex justify-evenly py-5">

            <div class="flex items-center justify-between flex-1 rounded border-2 border-gray-500 p-5 mx-5 my-1">
                <div >
                    <h3 class="text-2xl">Branches</h3>
                    <p class="text-5xl text-blue-800 ">5</p>
                </div>
                <img src="images/branches.svg" alt="branches_image" class="w-16 h-auto">
            </div>

            <div class="flex items-center justify-between flex-1 rounded border-2 border-gray-500 p-5 mx-5 my-1">
                <div>
                    <h3 class="text-2xl">Accounts</h3>
                    <p class="text-5xl text-green-800">5</p>
                </div>
                <img src="images/accounts.svg" alt="accounts_image" class="w-16 h-auto">
            </div>

        </div>

        <!-- Students -->
        <div class="h-60 flex justify-evenly py-2">

            <div class="flex items-center justify-between flex-1 rounded border-2 border-blue-300 p-5 mx-5 my-1">
                <div>
                    <h3 class="text-xl">Current Tutee</h3>
                    <p class="text-5xl text-blue-500 ">501</p>
                </div>
                <img src="images/tutee.svg" alt="branches_image" class="w-16 h-auto">
            </div>
            <div class="flex items-center justify-between flex-1 rounded border-2 border-blue-300 p-5 mx-5 my-1">
                <div >
                    <h3 class="text-xl">Total Tutee</h3>
                    <p class="text-5xl text-blue-500">1,162</p>
                </div>
                <img src="images/total_tutee.svg" alt="branches_image" class="w-16 h-auto">
            </div>
            <div class="flex items-center justify-between flex-1 rounded border-2 border-blue-300 p-5 mx-5 my-1">
                <div >
                    <h3 class="text-xl">Average Tutee (Monthly)</h3>
                    <p class="text-5xl text-blue-500 ">478</p>
                </div>
                <img src="images/montly.svg" alt="branches_image" class="w-16 h-auto">
            </div>
        ...
        <div class="w-full flex justify-between">
            ...
            <div class="w-full h-60 flex justify-center mx-2">
                <h1>Monthly Tutee</h1>
                <canvas id="monthly-tutee-chart"></canvas>
            </div>
